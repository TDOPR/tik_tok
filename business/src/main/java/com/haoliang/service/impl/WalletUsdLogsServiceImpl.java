...
public class WalletUsdLogsServiceImpl extends ServiceImpl<WalletUsdLogsMapper, WalletUsdLogs> implements WalletUsdLogsService {
    ...
    @Override
    public List<AppUsersAmountDTO> statYesterdayBuyVipAmount(LocalDate beginDate, LocalDate endDate) {
        return this.baseMapper.statYesterdayBuyVipAmount(beginDate,endDate,UsdLogTypeEnum.BUY_VIP.getValue());
    }
}
