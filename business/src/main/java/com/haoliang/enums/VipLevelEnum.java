...
public enum VipLevelEnum {
    ...
    ONE(1, new BigDecimal("50"), new BigDecimal("2"), new BigDecimal("75"), 5, new BigDecimal("0.13"), true),
    TWO(2, new BigDecimal("150"), new BigDecimal("3"), new BigDecimal("65"), 10, new BigDecimal("0.23"), true),
    THREE(3, new BigDecimal("500"), new BigDecimal("4"), new BigDecimal("55"), 15, new BigDecimal("0.60"), true),
    FOUR(4, new BigDecimal("1500"), new BigDecimal("5"), new BigDecimal("45"), 20, new BigDecimal("1.66"), true),
    FIVE(5, new BigDecimal("3000"), new BigDecimal("6"), new BigDecimal("45"), 25, new BigDecimal("2.66"), true),
    SIX(6, new BigDecimal("6000"), new BigDecimal("7"), new BigDecimal("45"), 30, new BigDecimal("4.44"), false),
    Seven(7, new BigDecimal("9000"), new BigDecimal("8"), new BigDecimal("45"), 35, new BigDecimal("5.71"), false);

    VipLevelEnum(Integer level, BigDecimal amount, BigDecimal num, BigDecimal day, Integer taskNumLimit, BigDecimal advertEarnings, boolean opening) {
        this.level = level;
        this.amount = amount;
        this.num = num;
        this.day = day;
        ...
        this.advertEarnings = advertEarnings;
    ...
    VipLevelEnum(Integer level, int taskNumLimit, BigDecimal outOfSaleAmount) {
        ...
        this.earnings = BigDecimalUtils.divideSaveTwoDecimal(earningsLimit, new BigDecimal(taskNumLimit));
        this.opening = true;
        this.advertEarnings = BigDecimal.ZERO;
    }
     ...
     * 每单广告收益
     */
    private BigDecimal advertEarnings;
    ...
    public static VipLevelEnum getByLevel(Integer level) {
        for (VipLevelEnum vipLevelEnum : values()) {
            if (vipLevelEnum.getLevel().equals(level) && vipLevelEnum.opening) {
                return vipLevelEnum;
            }
        }
        return null;
