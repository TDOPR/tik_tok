...
public interface WalletTttLogsMapper extends BaseMapper<WalletTttLogs> {
    ...
    Page<WalletTttLogs> pageByAllType(Page<WalletTttLogs> page, @Param("userId") Integer userId, @Param("beginDate") LocalDate beginDate, @Param("endDate") LocalDate endDate,
                                      @Param("dynamicTypeList")List<Integer> dynamicTypeList,@Param("taskTypeList")List<Integer>taskTypeList,@Param("otherTypeList")List<Integer>otherTypeList);
    ...
    BigDecimal sumTotalAmountByTypeListAndParentIdHasMe(List<Integer> typeList, Integer userId);
}
