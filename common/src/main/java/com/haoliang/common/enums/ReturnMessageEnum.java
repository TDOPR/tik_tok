...
public enum ReturnMessageEnum {
    ...
    BUY_NODE_LIMIT("buy_node_limit","购买名额已满！" ),
    NO_REPEAT_BUY("no_repeat_buy","不能重复购买！" ),
    PLEASE_UPDATE_VERSION("please_update_version","请更新到最新版本再使用！"),
    SEND_EMAIL_LIMIT_ERROR("send_email_limit_error","今天发送的邮件次数达到上限，请明天再发送！" ),
    WITHDRAW_LIMIT_ERROR("withdraw_limit_error","最低提现金额为 {} $！" );
